...
namespace Plus.AspNetCore.Authentication.OAuth.Claims
{
  ...
  ""role"": ""admin""
            ...
            new MultipleClaimAction(PlusClaimTypes.Role, "role").Run(jObject.RootElement, claimsIdentity, null);
            var claims = claimsIdentity.FindAll(PlusClaimTypes.Role).ToList();
