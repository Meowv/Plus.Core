...
namespace Plus.EventBus.RabbitMq
{
    ...
    {
        protected PlusRabbitMqEventBusOptions PlusRabbitMqEventBusOptions { get; }
        protected PlusDistributedEventBusOptions PlusDistributedEventBusOptions { get; }
        ...
        public RabbitMqDistributedEventBus(
            IOptions<PlusRabbitMqEventBusOptions> options,
            IConnectionPool connectionPool,
            IRabbitMqSerializer serializer,
            IServiceScopeFactory serviceScopeFactory,
            IOptions<PlusDistributedEventBusOptions> distributedEventBusOptions,
            ...
            : base(serviceScopeFactory)
        {
            ...
            PlusDistributedEventBusOptions = distributedEventBusOptions.Value;
            PlusRabbitMqEventBusOptions = options.Value;
        ...
        public void Initialize()
        {
            Consumer = MessageConsumerFactory.Create(
                new ExchangeDeclareConfiguration(
                    PlusRabbitMqEventBusOptions.ExchangeName,
                    type: "direct",
                    durable: true
                ),
                new QueueDeclareConfiguration(
                    PlusRabbitMqEventBusOptions.ClientName,
                    durable: true,
                    exclusive: false,
                    autoDelete: false
                ),
                PlusRabbitMqEventBusOptions.ConnectionName
            );

            Consumer.OnMessageReceived(ProcessEventAsync);

            SubscribeHandlers(PlusDistributedEventBusOptions.Handlers);
        }
        ...
        public override Task PublishAsync(Type eventType, object eventData)
        {
            ...
            using (var channel = ConnectionPool.Get(PlusRabbitMqEventBusOptions.ConnectionName).CreateModel())
            {
                ...
                channel.BasicPublish(
                   exchange: PlusRabbitMqEventBusOptions.ExchangeName,
