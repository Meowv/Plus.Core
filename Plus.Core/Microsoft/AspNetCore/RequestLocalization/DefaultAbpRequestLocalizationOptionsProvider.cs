...
{
    public class DefaultPlusRequestLocalizationOptionsProvider : IPlusRequestLocalizationOptionsProvider, ISingletonDependency
    {
        ...
        public DefaultPlusRequestLocalizationOptionsProvider(IServiceScopeFactory serviceProviderFactory)
        {
