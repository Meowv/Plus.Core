...
namespace Microsoft.Extensions.DependencyInjection
{
    public static class ServiceCollectionDynamicHttpClientProxyExtensions
    {
        ...
        /// See <see cref="PlusRemoteServiceOptions"/>.
        /// </param>
            ...
            bool asDefaultService = true)
        {
            ...
            services.Configure<PlusHttpClientOptions>(options =>
            {
            ...
            var interceptorAdapterType = typeof(PlusAsyncDeterminationInterceptor<>).MakeGenericType(interceptorType);

            var validationInterceptorAdapterType =
                typeof(PlusAsyncDeterminationInterceptor<>).MakeGenericType(typeof(ValidationInterceptor));
