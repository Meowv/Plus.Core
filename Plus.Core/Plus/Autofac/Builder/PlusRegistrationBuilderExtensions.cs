...
namespace Plus.Autofac.Builder
{
    ...
    {
        public static IRegistrationBuilder<TLimit, TActivatorData, TRegistrationStyle> ConfigurePlusConventions<TLimit, TActivatorData, TRegistrationStyle>(
        ...
        private static IRegistrationBuilder<TLimit, TActivatorData, TRegistrationStyle> EnablePropertyInjection<TLimit, TActivatorData, TRegistrationStyle>(
            ...
            where TActivatorData : ReflectionActivatorData
        {
            //Enable Property Injection only for types in an assembly containing an PlusModule
            ...
            where TActivatorData : ReflectionActivatorData
        {
            ...
            foreach (var interceptor in interceptors)
            {
                registrationBuilder.InterceptedBy(
                    typeof(PlusAsyncDeterminationInterceptor<>).MakeGenericType(interceptor)
                );
            }
