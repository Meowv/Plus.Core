...
using Plus.Ldap.Exceptions;
using Plus.Ldap.Modeling;
using System;
...
namespace Plus.Ldap
{
    public class LdapManager : ILdapManager, ITransientDependency
    {
        ...
        private readonly PlusLdapOptions _ldapOptions;
        ...
        public LdapManager(IOptions<PlusLdapOptions> ldapSettingsOptions, IHybridServiceScopeFactory hybridServiceScopeFactory)
        {
