...
namespace Plus.Security.Encryption
{
    /// <summary>
    ...
    {
        protected PlusStringEncryptionOptions Options { get; }

        public StringEncryptionService(IOptions<PlusStringEncryptionOptions> options)
        {
