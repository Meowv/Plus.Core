...
namespace Plus.Caching
{
        ...
        where TCacheItem : class
    {
        public DistributedCache(
            IOptions<PlusDistributedCacheOptions> distributedCacheOption,
        ...
        where TCacheItem : class
    {
        ...
        private readonly PlusDistributedCacheOptions _distributedCacheOption;
        ...
        protected virtual KeyValuePair<TCacheKey, TCacheItem>[] ToCacheItems(byte[][] itemBytes, TCacheKey[] itemKeys)
        {
            ...
            {
                throw new PlusException("count of the item bytes should be same with the count of the given keys");
            }
