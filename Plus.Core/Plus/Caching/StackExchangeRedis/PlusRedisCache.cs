...
namespace Plus.Caching.StackExchangeRedis
{
    ...
    public class PlusRedisCache : RedisCache, ICacheSupportsMultipleItems
    {
        ...
        public PlusRedisCache(IOptions<RedisCacheOptions> optionsAccessor)
