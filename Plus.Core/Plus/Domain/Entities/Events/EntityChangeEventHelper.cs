...
using Plus.Domain.Entities.Events.Distributed;
...
namespace Plus.Domain.Entities.Events
{
    /// <summary>
    ...
    public class EntityChangeEventHelper : IEntityChangeEventHelper, ITransientDependency
    {
        ...
        protected PlusDistributedEntityEventOptions DistributedEntityEventOptions { get; }

        public EntityChangeEventHelper(
            IUnitOfWorkManager unitOfWorkManager,
            IEntityToEtoMapper entityToEtoMapper,
            IOptions<PlusDistributedEntityEventOptions> distributedEntityEventOptions)
        {
