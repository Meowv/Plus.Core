...
namespace Plus.Http.ProxyScripting.Generators.JQuery
{
    //TODO: Add Plus.ajax, Plus.utils... etc.

    public class JQueryProxyScriptGenerator : IProxyScriptGenerator, ITransientDependency
    {
        //TODO: Should move this to Ddd package by adding an option to PlusHttpAbstractions module. Also duplicated of ApplicationService.CommonPostfixes
        ...
        public string CreateScript(ApplicationApiDescriptionModel model)
        {
            ...
            script.AppendLine("/* This file is automatically generated by Plus framework to use MVC Controllers from javascript. */");
            script.AppendLine();
        ...
        private static void AddAjaxCallParameters(StringBuilder script, ActionApiDescriptionModel action)
        {
            ...
            script.AppendLine("        url: Plus.appPath + '" + ProxyScriptingHelper.GenerateUrlWithParameters(action) + "',");
        ...
        {
            script.AppendLine();
            script.AppendLine("Plus.event.trigger('Plus.serviceProxyScriptInitialized');");
        }
