...
{
    public class PlusDictionaryBasedStringLocalizer : IStringLocalizer, IStringLocalizerSupportsInheritance
    {
        ...
        public class CultureWrapperStringLocalizer : IStringLocalizer, IStringLocalizerSupportsInheritance
        {
            ...
            private readonly PlusDictionaryBasedStringLocalizer _innerLocalizer;
            ...
            public CultureWrapperStringLocalizer(string cultureName, PlusDictionaryBasedStringLocalizer innerLocalizer)
            {
