...
using Plus.AspNetCore.Mvc.UI.Alerts;
...
{
    public abstract class PlusPageModel : PageModel
    {
        ...
        protected virtual IStringLocalizer CreateLocalizer()
        {
            ...
            if (localizer == null)
            {
                throw new PlusException($"Set {nameof(LocalizationResourceType)} or define the default localization resource type (by configuring the {nameof(PlusLocalizationOptions)}.{nameof(PlusLocalizationOptions.DefaultResourceType)}) to be able to use the {nameof(L)} object!");
            }
