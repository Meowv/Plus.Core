...
{
    public class PlusDataAnnotationAutoLocalizationMetadataDetailsProvider : IDisplayMetadataProvider
    {
        ...
        public PlusDataAnnotationAutoLocalizationMetadataDetailsProvider(IServiceCollection services)
        {
