...
{
    public class PlusApplicationConfigurationAppService : ApplicationService, IPlusApplicationConfigurationAppService
    {
        private readonly PlusLocalizationOptions _localizationOptions;
        private readonly PlusMultiTenancyOptions _multiTenancyOptions;
        ...
        private readonly PlusClockOptions _PlusClockOptions;
        ...
        protected virtual async Task<ApplicationAuthConfigurationDto> GetAuthConfigAsync()
        {
            ...
            var policyNames = await _PlusAuthorizationPolicyProvider.GetPoliciesNamesAsync();
        ...
        protected virtual ClockDto GetClockConfig()
        {
            return new ClockDto
            {
                Kind = Enum.GetName(typeof(DateTimeKind), _PlusClockOptions.Kind)
            };
        }
    }
}