...
{
    public class PlusServiceConvention : IPlusServiceConvention, ITransientDependency
    {
        private readonly PlusAspNetCoreMvcOptions _options;

        public PlusServiceConvention(IOptions<PlusAspNetCoreMvcOptions> options)
        {
        ...
        protected virtual AttributeRouteModel CreatePlusServiceAttributeRouteModel(string rootPath, string controllerName, ActionModel action, string httpMethod, [CanBeNull] ConventionalControllerSetting configuration)
        {
