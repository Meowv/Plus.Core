...
namespace Plus.Uow
{
    public class UnitOfWork : IUnitOfWork, ITransientDependency
    {
        ...
        public IPlusUnitOfWorkOptions Options { get; private set; }
        ...
        public UnitOfWork(IServiceProvider serviceProvider, IOptions<PlusUnitOfWorkDefaultOptions> options)
        {
        ...
        public virtual void Initialize(PlusUnitOfWorkOptions options)
        {
            Check.NotNull(options, nameof(options));

            if (Options != null)
            {
                throw new PlusException("This unit of work is already initialized before!");
            }
        ...
        public void AddDatabaseApi(string key, IDatabaseApi api)
        {
            ...
            {
                throw new PlusException("There is already a database API in this unit of work with given key: " + key);
            }
        ...
        public void AddTransactionApi(string key, ITransactionApi api)
        {
            ...
            {
                throw new PlusException("There is already a transaction API in this unit of work with given key: " + key);
            }
