...
{
    //TODO: Implement logic in DefaultDbContextResolver.Resolve in old Plus.
        ...
        where TDbContext : IEfCoreDbContext
    {
        ...
        public TDbContext GetDbContext()
        {
            ...
            if (unitOfWork == null)
            {
                throw new PlusException("A DbContext can only be created inside a unit of work!");
            }
        ...
        private TDbContext CreateDbContext(IUnitOfWork unitOfWork, string connectionStringName, string connectionString)
        {
            ...
            using (DbContextCreationContext.Use(creationContext))
            {
                ...
                if (dbContext is IPlusEfCoreDbContext PlusEfCoreDbContext)
                {
                    PlusEfCoreDbContext.Initialize(
                        new PlusEfCoreDbContextInitializationContext(
                            unitOfWork
                        )
                    );
                }
