...
using Plus.EntityFrameworkCore.ValueComparers;
...
{
    public static class PlusEntityTypeBuilderExtensions
    {
        ...
        public static void TryConfigureExtraProperties(this EntityTypeBuilder b)
        {
            ...
            b.Property<Dictionary<string, object>>(nameof(IHasExtraProperties.ExtraProperties))
                ...
                .Metadata.SetValueComparer(new PlusDictionaryValueComparer<string, object>());
